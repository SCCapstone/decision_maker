                    ...
                    try {
                        ...
                        if (action.equals("newCategory")) {
                            ...
                            if (getAll) {
                                ...
                                resultStatus = new ResultStatus(true, this.categoriesManager.getAllCategories(categoryIds));
                            } else {
                        ...
                        IOStreamsHelper.writeToOutput(outputStream, new ResultStatus(false, "Error: Unable to parse request. ").toString());
                    }
                } else {
